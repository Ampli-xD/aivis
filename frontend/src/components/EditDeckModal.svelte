    ...
    <div class="modal-content deck-modal">
        ...
        <div class="modal-body scrollable">
            <div class="form-group">
                <label for="deckNameEdit">DECK NAME</label>
                <input id="deckNameEdit" bind:value={name} class="modal-input">
            </div>

            <div class="form-group">
                <label for="deckBrandEdit">BRAND</label>
                <div id="deckBrandEdit" class="brand-display">{getBrandName(brandId)}</div>
            </div>
            ...
            <div class="form-group">
                <label for="promptSelectEdit">PROMPT SEQUENCES <span class="count-pill">{selectedPromptIds.length}</span></label>
                <div id="promptSelectEdit" class="multi-select-box lg-box">
            ...
            <div class="form-group">
                <label for="freqEdit">EXECUTION INTERVAL (SLOTS OF {appState.cronInterval} MIN)</label>
                <div style="display:flex;align-items:center;gap:12px">
                    <input id="freqEdit" type="number" bind:value={frequency} class="modal-input" style="width: 100px">
                    <div class="time-tip">
